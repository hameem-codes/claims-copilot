...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const getMemoriesForCustomer = useCallback(
    (customerId: string) => memories.filter((m) => m.customerId === customerId),
    [memories]
  );
  ...
  return (
    <AppContext.Provider
      value={{
        ...
        memories, getMemoriesForCustomer,
        activeClaimId, setActiveClaimId,
        claimViewMode, setClaimViewMode,
        insights,
      }}
    >
      {children}
